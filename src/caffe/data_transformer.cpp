...
//vector<int> DataTransformer::Transform(const Datum* datum, Dtype* buf, size_t buf_len) {
//  vector<int> shape;
...
//template<typename Dtype>
//void DataTransformer::TransformV1(const Datum& datum, Dtype* buf, size_t buf_len) {
...
//template<typename Dtype>
//void DataTransformer::Transform(const cv::Mat& src, Dtype* buf, size_t buf_len) {
//  cv::Mat tmp, dst;
...
//template<typename Dtype>
//void DataTransformer::Transform(const cv::Mat& img, TBlob<Dtype> *transformed_blob) {
//  const int crop_size = param_.crop_size();
...
//template<typename Dtype>
//void DataTransformer::Transform(Datum& datum, TBlob<Dtype>* transformed_blob) {
//  cv::Mat img;
