...
void SyncedMemory::to_cpu(bool zero_new_mem) {
  switch (head_) {
    case UNINITIALIZED:
...
void SyncedMemory::to_gpu(bool zero_new_mem) {
#ifndef CPU_ONLY
  switch (head_) {
    case UNINITIALIZED:
...
void* SyncedMemory::mutable_cpu_data(bool zero_new_mem) {
  to_cpu(zero_new_mem);
  head_ = HEAD_AT_CPU;
  return cpu_ptr_;
}

void* SyncedMemory::mutable_gpu_data(bool zero_new_mem) {
#ifndef CPU_ONLY
  to_gpu(zero_new_mem);
  head_ = HEAD_AT_GPU;
  return gpu_ptr_;
